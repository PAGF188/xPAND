...
def _get_builtin_metadata(dataset_name, split=None, partition=None):   
    # split and partition are new fields only for VOC
    ...
    if dataset_name == "coco_panoptic_separated":
        ...
        if partition == "base":
            return {
                "thing_classes": PASCAL_VOC_BASE_CATEGORIES[split],
            }
        elif partition == "novel":
            return {
                "thing_classes": PASCAL_VOC_NOVEL_CATEGORIES[split],
            }
        elif partition == "base_novel":
            return {
                "thing_classes": PASCAL_VOC_ALL_CATEGORIES[split],
            }
        raise KeyError("No built-in metadata for dataset {}, split: {}, partition: {}".format(dataset_name, split, partition))
