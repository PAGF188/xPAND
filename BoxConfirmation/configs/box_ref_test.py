...
dataloader.test.dataset.names = "tfa_30shot_seed0"
...
dataloader['evaluator']['output_dir'] = os.path.join(OUTPUT_DIR, "BC_output")
...
train.init_checkpoint = (
    "/models/BC_f/BC_finetuning_sintetic_freeze/model_final.pth"
)
