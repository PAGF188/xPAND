...
from ..data.builtin import register_all_voc, register_all_coco
...
dataloader.test.dataset.names = "prueba_VOC_test"
...
dataloader['evaluator']['output_dir'] = "datasets/debug_VOC/inference"
...
train.init_checkpoint = (
    "BC_VOC/10shot_split1/model_final.pth"
)

train.eval_period = 40000
train.checkpointer.period = 20000
train.output_dir = "datasets/debug_VOC"
# Schedule
