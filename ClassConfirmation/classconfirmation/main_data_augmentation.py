...
parser = argparse.ArgumentParser(description='Label Confirmation training with data augmentation')
...
def main(config):
    ...
    if config['TYPE'] == 'train':
        ...
        train_set = COCODatasetMetaLearning(config['DATASETS']['TRAIN_JSON'], config['DATASETS']['SUPPORT_JSON'], config['DATASETS']['DATA_FOLDER'], transforms, image_format=config['DATASETS']['IMG_FORMAT'], support_size=config['DATASETS']['SUPPORT_SIZE'], augmentations_query=augmentations_both, augmentations_support=augmentations_both)
    ...
    test_set = COCODatasetMetaLearningTEST(config['DATASETS']['TEST_JSON'], config['DATASETS']['SUPPORT_TEST_JSON'], config['DATASETS']['DATA_FOLDER'], transforms, image_format=config['DATASETS']['IMG_FORMAT'], support_size=config['DATASETS']['SUPPORT_SIZE'])
